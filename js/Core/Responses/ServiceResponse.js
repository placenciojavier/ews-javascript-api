...
var ServiceResponse = (function () {
    ...
    ServiceResponse.prototype.ReadElementsFromXmlJsObject = function (jsObject, service) {
        ...
        EwsLogging_1.EwsLogging.Assert(false, caller + ".ReadElementsFromXmlJsObject", "BatchProcessingStopped is false but ReadElementsFromXmlJsObject is not available in derived class to call.");
    };
    /**
