...
var ExchangeService = (function (_super) {
    ...
    ExchangeService.prototype.GetClientExtension = function (requestedExtensionIds, shouldReturnEnabledOnly, isUserScope, userId, userEnabledExtensionIds, userDisabledExtensionIds, isDebug) { throw new Error("ExchangeService.ts - GetClientExtension : Not implemented."); };
    ExchangeService.prototype.SetClientExtension = function (actions /*System.Collections.Generic.List<T>*/) { throw new Error("ExchangeService.ts - SetClientExtension : Not implemented."); };
    ExchangeService.prototype.GetEncryptionConfiguration = function () { throw new Error("ExchangeService.ts - GetEncryptionConfiguration : Not implemented."); };
    ExchangeService.prototype.SetEncryptionConfiguration = function (imageBase64, emailText, portalText, disclaimerText) { throw new Error("ExchangeService.ts - SetEncryptionConfiguration : Not implemented."); };
